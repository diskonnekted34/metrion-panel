...
const DataSourceEmptyState = () => (
  <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} className="mb-10">
    <div className="glass-card p-10 text-center">
      ...
      <h3 className="text-lg font-semibold text-foreground mb-2">Canlı izleme aktif değil.</h3>
      <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
        Gerçek zamanlı yönetici izleme ve departmanlar arası istihbaratı etkinleştirmek için veri kaynaklarınızı bağlayın.
      </p>
