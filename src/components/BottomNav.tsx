        ...
        {menuOpen && (
          <>
            ...
            <div className="absolute right-4 top-11 z-50 glass-strong rounded-2xl border border-border py-2 min-w-[160px] shadow-xl">
              ...
              <Link to="/okr" onClick={() => setMenuOpen(false)} className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-foreground hover:bg-secondary">
                <BarChart3 className="h-4 w-4 text-muted-foreground" /> OKR
              </Link>
