              ...
              {insights.map((insight, i) => (
                <div key={i} className={`${i === 1 ? "glass-bento" : "glass-card"} p-5 flex items-center justify-between gap-4`}>
                  <div className="flex items-start gap-3 flex-1">
                    <div className={`rounded-2xl p-2 shrink-0 ${insight.urgency === "Critical" ? "bg-destructive/15" : insight.urgency === "High" ? "bg-primary/15" : "bg-white/[0.06]"}`}>
              ...
              {executives.map((exec, i) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                     <Link to={`/expert/${exec.id}`} className="flex-1 text-center text-xs py-2 rounded-2xl bg-white/[0.05] hover:bg-white/[0.08] text-foreground transition-colors">
                      {t.dashboard.open}
                    </Link>
                    <button className="flex-1 text-xs py-2 rounded-2xl bg-primary/15 hover:bg-primary/25 text-primary transition-colors">
                      {t.dashboard.assign}
                    </button>
                  </div>
                </motion.div>
