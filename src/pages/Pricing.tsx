          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="h-12 w-12 rounded-[20px] bg-accent flex items-center justify-center">
              ...
              <Link to="/marketplace" className="block w-full text-center rounded-[20px] border border-border px-6 py-3.5 text-sm font-medium text-foreground transition-all hover:bg-accent active:scale-[0.99]">
            ...
            >
              <div className="absolute top-4 right-4">
                <span className="text-[10px] font-bold px-3 py-1.5 rounded-full bg-primary text-primary-foreground uppercase tracking-wider">
                  {t.pricing.bundleBadge}
                </span>
              </div>

              <div className="flex items-center gap-3 mb-6">
                <div className="h-12 w-12 rounded-[20px] bg-primary/20 flex items-center justify-center">
              ...
              <button className="w-full rounded-[20px] bg-primary px-6 py-3.5 text-sm font-medium text-primary-foreground transition-all hover:opacity-90 active:scale-[0.99] btn-glow flex items-center justify-center gap-2">
